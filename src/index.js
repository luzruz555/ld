...
<svg width="${W}" height="${H}" viewBox="0 0 ${W} ${H}" xmlns="http://www.w3.org/2000/svg">
  ...
  <g clip-path="url(#stageClip)">
    ...
    <g transform="translate(24,24)">
      ...
      <text x="29" y="34" font-family="'Noto Sans KR', sans-serif" font-size="13" font-weight="800" fill="${color}" text-anchor="middle">Lv${level}</text>
      <!-- 하트 아이콘 -->
      ...
      <text x="93" y="21" font-family="'Noto Sans KR', sans-serif" font-size="11" font-weight="700" fill="#97a0ab">호감도 <tspan fill="#384049" font-size="13">${affection}</tspan></text>
